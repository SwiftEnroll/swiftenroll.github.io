...
{{< features-section title="Fair Enrollment & Waitlists" description="Flexible placement algorithms with automated approvals and waitlist management. Ideal for high-demand <a href=\"/industries/after-school-enrichment-programs/\">after school enrichment programs</a> and <a href=\"/industries/preschool-early-childhood-programs/\">preschool enrollment</a>." columns="2" id="waitlists-and-placement" >}}
...
{{< feature
    ...
    description="Cards, ACH, and wallets with pro‑grade reliability."
    features="Installments,Refunds & credits,Coupons & discounts"
/>}}
...
{{< features-section title="Admin tools & reporting" description="Operational control for program directors and admins." columns="2" id="admin-tools-and-reporting" >}}
...
{{< features-section title="Communications" description="Keep families informed automatically." columns="2" id="communications" >}}
...
{{< features-section title="Integrations" description="Connect your finance stack and student systems." columns="2" id="integrations" >}}

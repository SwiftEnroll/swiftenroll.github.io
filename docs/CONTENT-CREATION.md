...
- Canonical URL: automatically set to page permalink
...
9. **Sitemap**: Auto-generated at `/sitemap.xml`
10. **robots.txt**: Configured at `/robots.txt` to allow all crawlers

**Note**: Canonical URLs, OpenGraph tags, and Twitter cards are automatically added to all pages.
